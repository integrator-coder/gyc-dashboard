...
// Local image paths - embed directly into slides
const imagePaths = [
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide01_title---fbab9c8e-3323-4052-82df-f205c47dd27b.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide02_big_picture---40d2d2ac-6082-4efb-8e8f-2e87b784d6fd.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide03_what_is_mps---95027fc2-51a3-490b-adec-9bbfafcda180.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide04_mtor_explained---df87cb12-8598-43bc-9532-50c45ba888b7.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide05_what_is_mpb---0d8e3ec8-76c3-4706-a9ab-6cf1006cfaf0.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide06_mpb_drivers---5b2b26c4-f25a-4186-9df3-ae99778cd960.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide07_anabolic_resistance---2a8b6bf8-d573-4c7e-a8c9-af0d55f331ae.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide08_tax_rate_math---1cacb9ea-e0be-42f2-830a-f4f3b0a58729.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide09_strategy_enhancements---50612add-e6fc-493a-b2bb-9931eee25713.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide10_steroid_mechanism---38fcc647-6a86-42c3-9d28-4ca3e1984b36.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide11_intraworkout_carbs---36590889-6829-4bc2-ba53-1211c3690556.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide12_insulin_anticatabolic---f62a7fa8-62cf-46c7-a633-f692e1c111b1.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide13_sleep_and_muscle---db18bed2-4e2b-4265-9c74-3a4f4b0046d7.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide14_gh_igf1_explained---04beb369-095b-488f-b708-e53a0f2d8413.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide15_caffeine_management---e113afde-01f6-4d4b-a09e-7897efb10ebc.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide16_full_protocol---239df5ed-fd88-437c-956a-68de98c0876e.png',
  '/Users/toddthejedigmail.com/.openclaw/media/tool-image-generation/slide17_glossary---ec02d82d-ed1a-44a1-a8ed-b4eb7a7736a8.png'
];
...
async function buildDeck() {
  console.log('Building comprehensive Muscle Tax deck...\n');
  ...
  await buildSlide(firstSlideId, slideData[0], imagePaths[0], pageWidth, pageHeight, false);
  ...
  for (let i = 1; i < slideData.length; i++) {
    ...
    // Build the slide
    await buildSlide(slideId, slideData[i], imagePaths[i], pageWidth, pageHeight, true);
  }
  
  console.log('\n✅ Comprehensive deck complete — 17 slides!');
  console.log(`https://docs.google.com/presentation/d/${PRES_ID}/edit`);
}

async function buildSlide(slideId, data, imagePath, pageWidth, pageHeight, clearSlide) {
  const requests = [];
  ...
  // Add semi-transparent overlay on left side (65% width for more text space)
  const overlayId = `overlay_${slideId}`;
  const overlayWidth = pageWidth * 0.65;
  requests.push({
    createShape: {
      objectId: overlayId,
      shapeType: 'RECTANGLE',
      elementProperties: {
        pageObjectId: slideId,
        size: { 
          width: { magnitude: overlayWidth, unit: 'EMU' }, 
          height: { magnitude: pageHeight, unit: 'EMU' } 
        },
        transform: {
          scaleX: 1,
  ...
  const titleWidth = overlayWidth * 0.92;
