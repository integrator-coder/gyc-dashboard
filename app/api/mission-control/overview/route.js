...
export async function GET() {
  ...
  const agents = [
    ...
    {
      name: 'Chopper',
      role: 'Mouse Worker Agent',
      category: 'worker',
      node: 'GYC-Growth-Claw (10.0.0.171)',
      status: 'idle',
      currentTask: 'Awaiting task from Mouse',
      lastActivity: nowIso,
      reportsTo: 'Mouse',
      children: [],
    },
    ...
    {
      name: 'Thrawn',
      role: 'Division Lead — Business Intelligence',
      category: 'worker',
      node: 'Mac Mini',
      status: inProgress.some((t) => t.owner === 'Thrawn') ? 'working' : 'idle',
      currentTask: inProgress.find((t) => t.owner === 'Thrawn')?.title || 'Monitoring churn risk + client signals',
      lastActivity: nowIso,
      reportsTo: 'Wall·E',
      children: ['Soundwave', 'Ratchet'],
    },
    {
      name: 'Soundwave',
      role: 'Call Analysis Specialist',
      category: 'worker',
      node: 'Mac Mini',
      status: inProgress.some((t) => t.owner === 'Soundwave') ? 'working' : 'idle',
      currentTask: inProgress.find((t) => t.owner === 'Soundwave')?.title || 'Processing call transcripts',
      lastActivity: nowIso,
      reportsTo: 'Thrawn',
      children: [],
    },
    {
      name: 'Morpheus',
      role: 'Memory Dreaming',
      category: 'worker',
      node: 'Mac Mini',
      status: inProgress.some((t) => t.owner === 'Morpheus') ? 'working' : 'idle',
      currentTask: inProgress.find((t) => t.owner === 'Morpheus')?.title || 'Nightly memory consolidation',
      lastActivity: nowIso,
      reportsTo: 'Yoda',
      children: [],
    },
    ...
    },
    {
      ...
      lastActivity: nowIso,
      reportsTo: 'Wall·E',
      children: ['Chopper', 'Cassian', 'Coulson', 'Pepper'],
    },
    {
      name: 'Cassian',
      ...
      node: 'GYC-Growth-Claw (10.0.0.171)',
      status: 'idle',
      currentTask: 'Monitoring research queues',
      lastActivity: nowIso,
      reportsTo: 'Mouse',
      children: [],
    },
    {
      name: 'Coulson',
      role: 'Onboarding Overseer',
      category: 'worker',
      node: 'GYC-Growth-Claw (10.0.0.171)',
      status: 'idle',
      currentTask: 'Tracking onboarding pipeline',
      lastActivity: nowIso,
      reportsTo: 'Mouse',
      children: [],
    },
    {
      ...
      node: 'GYC-Growth-Claw (10.0.0.171)',
      status: 'idle',
      currentTask: 'Monitoring billing + Stripe health',
      lastActivity: nowIso,
      reportsTo: 'Mouse',
      children: [],
    },
