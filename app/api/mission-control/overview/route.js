  ...
  const agents = [
    {
      ...
      lastActivity: nowIso,
      reportsTo: null,
      children: ['R2', 'Eve', 'Relay', 'Validator', 'Guardian', 'Friday'],
    },
    {
      name: 'Eve',
      role: 'Sync + Data Node',
      ...
      reportsTo: 'Wall·E',
      children: ['BB-8', 'Fulcrum', 'Sentinel'],
    },
    {
      name: 'R2',
      role: 'Builder Agent',
    ...
    },
    {
      ...
      category: 'worker',
      node: 'Mac Mini',
      status: inProgress.some((t) => t.owner === 'Relay') ? 'working' : 'idle',
      currentTask: inProgress.find((t) => t.owner === 'Relay')?.title || 'Task routing + status summaries',
      lastActivity: nowIso,
      reportsTo: 'Wall·E',
      children: [],
    },
    {
      ...
      category: 'worker',
      node: 'Mac Mini',
      status: inProgress.some((t) => t.owner === 'Validator') ? 'working' : 'idle',
      currentTask: inProgress.find((t) => t.owner === 'Validator')?.title || 'Build validation + smoke tests',
      lastActivity: nowIso,
      reportsTo: 'Wall·E',
      children: [],
    },
    {
      ...
      category: 'worker',
      node: 'Mac Mini',
      status: inProgress.some((t) => t.owner === 'Guardian') ? 'working' : 'idle',
      currentTask: inProgress.find((t) => t.owner === 'Guardian')?.title || 'Monitoring agent health + cron status',
      lastActivity: nowIso,
      reportsTo: 'Wall·E',
      children: [],
    },
    {
      ...
      category: 'worker',
      node: 'Mac Studio',
      status: inProgress.some((t) => t.owner === 'Sentinel') ? 'working' : 'idle',
      currentTask: inProgress.find((t) => t.owner === 'Sentinel')?.title || 'Security posture + snapshot freshness checks',
      lastActivity: nowIso,
      reportsTo: 'Eve',
      children: [],
    },
