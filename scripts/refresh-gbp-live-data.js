#!/usr/bin/env node
/**
 * refresh-gbp-live-data.js
 * Fetches live GBP data (rating, coords, hours, photos) for all GBP locations
 * belonging to active SEO clients that are missing liveDataSnapshot or coordinates.
 *
 * Uses the same DataForSEO lookup the API route uses.
 * Run: node scripts/refresh-gbp-live-data.js
 * Run one client: node scripts/refresh-gbp-live-data.js CTI
 */
