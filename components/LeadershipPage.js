  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-5">
        ...
        <Card label="RPE (MRR)" value={fmt$(Number(metrics?.mrr || 0) * 12 / 16)} sub="MRR x12 / 16" tooltip="Revenue Per Employee based on MRR: (MRR × 12) ÷ 16 headcount. Measures annualized MRR productivity per team member. Headcount fixed at 16." />
        <Card label="RPE (Revenue)" value={fmt$(estAnnualRevenue / 16)} sub="YTD ann. / 16" tooltip={`Revenue Per Employee based on YTD annualized revenue: (YTD ÷ ${daysElapsed}d × 365) ÷ 16 headcount. Includes one-time fees. Headcount fixed at 16.`} />
