...
const AGENT_MODEL = {
  ...
  'R2':      'GPT-5.6 Sol',
  'Yoda':  'GPT-5.6 Sol',
  'Thrawn':   'DeepSeek V4 Flash',
  'Soundwave':    'Gemini 2.5 Flash Lite',
...
const BASE_AGENT_MODEL_ACCESS = {
  ...
  'Yoda':      { default: 'GPT-5.6 Sol', escalate: null },
  'Thrawn':     { default: 'DeepSeek V4 Flash', escalate: 'GPT-5.6 Sol (via Wall·E)' },
  'Soundwave': { default: 'Gemini 2.5 Flash Lite', escalate: 'GPT-5.6 Sol (via Wall·E)' },
  'Echo':      { default: 'DeepSeek V4 Flash', escalate: 'GPT-5.6 Sol (via Wall·E)' },
